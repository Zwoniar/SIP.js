...
module.exports = function (SIP) {
  ...
  InviteServerContext.prototype = Object.create({}, {
    reject: {
      writable: true, value: function (options) {
        // Check Session Status
        if (this.status === C.STATUS_TERMINATED) {
          throw new SIP.Exceptions.InvalidStateError(this.status);
        }
    ...
    receiveRequest: {
      writable: true, value: function (request) {
  ...
  InviteClientContext.prototype = Object.create({}, {
    ...
    receiveInviteResponse: {
      writable: true, value: function (response) {
        var cause,
          session = this,
  ...
  ReferServerContext.prototype = Object.create({}, {
    ...
    accept: {
      writable: true, value: function (options, modifiers) {
        options = options || {};
    ...
    sendNotify: {
      writable: true, value: function (body) {
